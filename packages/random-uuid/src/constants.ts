/**
 * Number of random bytes needed to generate a v4 UUID.
 */
 ...
 *
 * The legacy Expo fallback (`ExpoRandom.getRandomBase64String`) returns random
 * bytes as a base64 `string` over the synchronous bridge, so JS decodes it
 * back to bytes without an external dependency.
 *
 * How it works:
