...
function getLinkingError(): Error {
  ...
  return new Error(
    `The package '@the-polyfills/random-uuid' doesn't seem to be linked. Make sure:\n\n` +
      iosHint +
...
export function randomUUID(): string {
  ...
  // Note: loose inequality (`!= null`) intentionally covers both `null`
  // and `undefined`, narrowing `Spec | undefined` down to `Spec`.
  if (native != null) {
